        ...
        for (var aK = 0; aK < aP; ++aK) {
            ...
            do {
                ...
                if (aI._$yo()) {
                    var aJ = aI._$IP;
                    var aL = this._$Hr[aJ];
                    var partID = aL._$e0._$NL.id;
                    elementList.push({ element: element, partID: partID });
                }
                var nextElement = this._$Er[element];
                // y._$W0 is -1
                if (nextElement <= element || nextElement == y._$W0) {
                    break;
                }
                element = nextElement;
            } while (true);
